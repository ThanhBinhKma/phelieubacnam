...
<link href="{{asset('home/plugin-frameworks/bootstrap.css')}}" rel="stylesheet">
<link href="{{asset('home/font/ionicons.css')}}" rel="stylesheet">
<link href="{{asset('home/common/style.css')}}" rel="stylesheet">
</head>
<body>
<header>
<div class="bg-191">
...
<div class="container">
<a class="logo" href="index.html"><img src="{{asset('home/images/logo-black.png')}}" alt="Logo"></a>
...
<div class="row">
<div class="col-sm-6">
<img src="{{asset('home/images/recent-news-1-600x450.jpg')}}" alt="">
...
<div class="wh-100x abs-tlr"><img src="{{asset('home/images/polular-1-100x100.jpg')}}" alt=""></div>
...
<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
<div class="wh-100x abs-tlr"><img src="{{asset('home/images/polular-2-100x100.jpg')}}" alt=""></div>
<div class="ml-120 min-h-100x">
<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
</div>
...
<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
<div class="wh-100x abs-tlr"><img src="{{asset('home/images/polular-3-100x100.jpg')}}" alt=""></div>
<div class="ml-120 min-h-100x">
<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
</div>
...
<a class="oflow-hidden pos-relative mb-20 dplay-block" href="#">
<div class="wh-100x abs-tlr"><img src="{{asset('home/images/polular-4-100x100.jpg')}}" alt=""></div>
<div class="ml-120 min-h-100x">
<h5><b>Bitcoin Billionares Hidding in Plain Sight</b></h5>
<h6 class="color-lite-black pt-10">by <span class="color-black"><b>Danile Palmer,</b></span> Jan 25, 2018</h6>
</div>
...
<div class="row">
<div class="col-sm-6">
<img src="{{asset('home/images/crypto-news-6-600x450.jpg')}}" alt="">
<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br />Crypto vs.Stock</b></a></h4>
...
<div class="col-sm-6">
<img src="{{asset('home/images/crypto-news-5-600x450.jpg')}}" alt="">
<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br />Crypto vs.Stock</b></a></h4>
<ul class="list-li-mr-20 pt-10 mb-30">
<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
Jan 25, 2018</li>
...
<div class="col-sm-6">
<img src="{{asset('home/images/crypto-news-4-600x450.jpg')}}" alt="">
<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br />Crypto vs.Stock</b></a></h4>
<ul class="list-li-mr-20 pt-10 mb-30">
<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
Jan 25, 2018</li>
...
<div class="col-sm-6">
<img src="{{asset('home/images/crypto-news-3-600x450.jpg')}}" alt="">
<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br />Crypto vs.Stock</b></a></h4>
<ul class="list-li-mr-20 pt-10 mb-30">
<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
Jan 25, 2018</li>
...
<div class="col-sm-6">
<img src="{{asset('home/images/crypto-news-2-600x450.jpg')}}" alt="">
<h4 class="pt-20"><a href="#"><b>2017 Market Performance: <br />Crypto vs.Stock</b></a></h4>
<ul class="list-li-mr-20 pt-10 mb-30">
<li class="color-lite-black">by <a href="#" class="color-black"><b>Olivia Capzallo,</b></a>
Jan 25, 2018</li>
...
<div class="col-sm-6">
<img src="{{asset('home/images/crypto-news-1-600x450.jpg')}}" alt="">
...
<img src="{{asset('home/images/banner-1-600x450.jpg')}}" alt="">
...
<div class="h-80 pos-relative"><img class="opacty-1 h-100 w-auto" src="{{asset('home/images/map.png')}}" alt=""></div>
</div>
<div class="row">
<div class="col-sm-4">
<div class="mb-30">
<a href="#"><img src="{{asset('home/images/logo-white.png')}}"></a>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7c921d8d8f1c10a9","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2023.4.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>